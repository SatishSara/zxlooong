...
INT_PTR APIENTRY PrintProc(HWND, UINT, WPARAM, LPARAM) ;
INT_PTR APIENTRY DevnamesProc(HWND, UINT, WPARAM, LPARAM) ;
INT_PTR APIENTRY DevmodeProc(HWND, UINT, WPARAM, LPARAM) ;

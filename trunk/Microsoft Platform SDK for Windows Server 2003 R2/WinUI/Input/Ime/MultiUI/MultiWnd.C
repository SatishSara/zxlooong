    ...
    PTSTR pResultStr)
{
    ...
    else
    {
        ...
        if (pTempStr)
        {
            _tcsncpy(pTempStr, pStr, MAXSIZE_STR - 1);
            _tcsncat(pTempStr, pResultStr, min(MAXSIZE_STR - _tcslen(pTempStr) - 1, _tcslen(pResultStr)));
    ...
    HWND hWnd)
{
    ...
    if (dwLen)
    {
        ...
        if (pResultStr)
        {
            ...
            {
                _tcsncpy(pStr, pResultStr, MAXSIZE_STR - 1);
            }
            else
            {
                _tcsncat(pStr, pResultStr, min(MAXSIZE_STR - _tcslen(pStr) - 1, _tcslen(pResultStr)));
            }

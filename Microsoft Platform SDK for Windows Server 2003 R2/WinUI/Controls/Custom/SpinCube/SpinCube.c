...
UINT CALLBACK CustomControlInfo (LPCCINFO acci)
{
  ...
  lstrcpyn (acci[0].szClass, SPINCUBECLASS, ARRAYSIZE(acci[0].szClass));
  lstrcpyn (acci[0].szDesc,  SPINCUBEDESCRIPTION, ARRAYSIZE(acci[0].szDesc));
  lstrcpyn (acci[0].szTextDefault, SPINCUBEDEFAULTTEXT, ARRAYSIZE(acci[0].szTextDefault));

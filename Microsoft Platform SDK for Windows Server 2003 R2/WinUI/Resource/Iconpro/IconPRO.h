...
BOOL GetSaveIconFileName( PTSTR szFileName, UINT FilterStringID, PCTSTR szTitle );
BOOL GetOpenIconFileName( PTSTR szFileName, UINT FilterStringID, PCTSTR szTitle );
/****************************************************************************/

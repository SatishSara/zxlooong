    ...
    )
{
    ...
    else if ( NIStringCompareW( pwszResourceTypeIn, RESTYPE_NAME, RTL_NUMBER_OF( RESTYPE_NAME ) ) == 0 )
    {
    ...
    )
{
    ...
    if (   (    ( pResourceEntryIn->props.pwszShareName != NULL )
             && ( IStringCompareW( props.pwszShareName, pResourceEntryIn->props.pwszShareName ) != 0 )
           )
        || (    ( pResourceEntryIn->props.pwszPath != NULL )
             && ( IStringCompareW( props.pwszPath, pResourceEntryIn->props.pwszPath ) != 0 )
           )
       )
    {

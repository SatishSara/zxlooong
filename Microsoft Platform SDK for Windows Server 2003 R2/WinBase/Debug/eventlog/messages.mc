...
;
;
; NOTE: The Message Compiler shipped with the August '96 Win32 SDK is broken
; and ignores the MessageIdTypedef parameter. DWORD is used in all cases.
; Because of this problem, the .h files generated by mc.exe are bad; all
; WORD casts must be replaced with DWORD casts in order for your application
...
; code.
;
; Event log categories - these values can be used in the fwCategory
...
Language=English
File %1 contains %2which is in error
.
...
Language=English
Insert %%1001in %%1002%1 and hit any key when ready... 
.
